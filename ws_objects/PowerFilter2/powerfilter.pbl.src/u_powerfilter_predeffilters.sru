...
public function integer of_position ();//********************************************************************* 
// Object:                u_powerfilter_predeffilters 
// Method:                of_position (function) 
// 
// Description:        Position the list based on associated dropdown and location on screen 
// 
// Arg(s):                 (none) 
// 
// Returns:                 integer 
//********************************************************************* 
// History: 
//        Date                        Who        Ticket#        Comments 
//-------------------------------------------------------------------------------------------------------------- 
//        5/17/2011        JRR        79770                Test space limit for left side positionioning, overlap on right if not enough space (small parent window) 
//********************************************************************* 
/* 
        PowerFilter Datawindow Filter Service 
        Copyright © 2010 James R. Reese.  All Rights Reserved. 
...
IF this.x + this.width > parent.dynamic workspacewidth( ) THEN 
	IF iu_powerfilter_dropdown.x - this.width > 0 THEN //JRR 79770 - don't assume there is room to the left, test to see 
	...
	END IF //JRR 79770 
END IF
this.y = iu_powerfilter_dropdown.y + (80 * (iu_powerfilter_dropdown.dw_buttons.rowcount() - 1)) + 4 
...
*/
//this is in development, testing right now by chopping size in half
