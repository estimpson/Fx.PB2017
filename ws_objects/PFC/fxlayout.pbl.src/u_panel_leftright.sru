$PBExportHeader$u_panel_leftright.sru
forward
global type u_panel_leftright from u_base
end type
type uo_2 from u_panel within u_panel_leftright
end type
type uo_1 from u_panel within u_panel_leftright
end type
type st_1 from u_st_splitbar within u_panel_leftright
end type
end forward
...
global u_panel_leftright u_panel_leftright
