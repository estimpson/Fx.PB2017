...
event type integer pfc_splitbarbegin ( )
event pfc_splitbarend ( )
mdi_1 mdi_1
end type
...
event type integer pfc_splitbarbegin();
//	Notify frame of splitbar movement and allow it or not.
return CONTINUE_ACTION // or PREVENT_ACTION
...
event pfc_splitbarend;
//	Notify frame of splitbar movement ending.
