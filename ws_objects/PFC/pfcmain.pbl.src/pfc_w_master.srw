...
n_cst_associative_array Container // Used to store visual and non-visual components of the window in a loosely coupled fashion.
...
If Len (Trim (ls_helpfile)) > 0 Then
	...
	Else
		Return ShowHelp (ls_helpfile, keyword!, "")
	End If
End If
