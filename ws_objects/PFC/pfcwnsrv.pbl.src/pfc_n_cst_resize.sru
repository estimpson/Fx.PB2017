...
type os_resize from structure within pfc_n_cst_resize
end type
end forward
...
public function integer getminimumheight ()
public function integer getminimumwidth ()
end prototypes
...
Choose Case awo_control.TypeOf()
	Case checkbox!, commandbutton!, datawindow!, dropdownlistbox!, &
			...
			olecustomcontrol!, omembeddedcontrol!, olecontrol!, statichyperlink!
		Return DRAGOBJECT
	Case line!
		Return LINE
	Case oval!
...
public function integer getminimumheight ();return il_parentminimumheight

end function

public function integer getminimumwidth ();return il_parentminimumwidth
