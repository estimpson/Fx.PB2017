...
type prototypes
// Sound
Function boolean sndPlaySoundA (string SoundName, ulong Flags) Library "libkernel40.a" alias for "sndPlaySoundA;Ansi"
//Function uint waveOutGetNumDevs () Library "WINMM.DLL"

// Get free memory
Subroutine GlobalMemoryStatus (ref os_memorystatus memorystatus ) Library "libkernel40.a" alias for "GlobalMemoryStatus;Ansi"

// Get module handle
Function ulong GetModuleHandleA(string modname) Library "libkernel40.a" alias for "GetModuleHandleA;Ansi"

// Window functions
Function ulong GetWindowTextA(ulong handle, ref string wintext, ulong length) Library "libuser40.a" alias for "GetWindowTextA;Ansi"
Function ulong GetWindowsDirectoryA (ref string dirtext, ulong textlen) library "libkernel40.a" alias for "GetWindowsDirectoryA;Ansi"
Function ulong GetSystemDirectoryA (ref string dirtext, ulong textlen) library "libkernel40.a" alias for "GetSystemDirectoryA;Ansi"
function ulong FindWindowA( ref string lpClassName, ref string lpWindowName) Library "libuser40.a" alias for "FindWindowA;Ansi"


// User/computer information
Function boolean GetUserNameA(ref string  lpBuffer, ref ulong nSize) library "libkernel40.a" alias for "GetUserNameA;Ansi"
function boolean GetComputerNameA(ref string  lpBuffer, ref ulong nSize) library "libkernel40.a" alias for "GetComputerNameA;Ansi"

// Get text size
Function ulong GetDC(ulong hWnd) Library "libgdi40.a"
Function long ReleaseDC(ulong hWnd, ulong hdcr) Library "libgdi40.a"
Function boolean GetTextExtentPoint32A(ulong hdcr, string lpString, long nCount, ref os_size size) Library "libgdi40.a" alias for "GetTextExtentPoint32A;Ansi"
Function ulong SelectObject(ulong hdc, ulong hWnd) Library "libgdi40.a"
