...
public function integer of_DirList (string as_filespec, long al_filetyp, ref n_cst_dirattrib anv_dirlist[])
...
public function integer of_CreateDirectory (string as_directoryname);//	Function not found in descendent

Return -1

end function

public function string of_GetCurrentDirectory ();//	Function not found in descendent

Return ""

end function

public function boolean of_DirectoryExists (string as_DirectoryName);//	Function not found in descendent

Return False

end function

public function integer of_ChangeDirectory (string as_NewDirectory);//	Function not found in descendent

Return -1

end function

public function integer of_RemoveDirectory (string as_directoryname);//	Function not found in descendent
...
public function integer of_FileRename (string as_sourcefile, string as_targetfile);//	Function not found in descendent

Return -1

end function

public function integer of_DirList (string as_filespec, long al_filetyp, ref n_cst_dirattrib anv_dirlist[]);//	Function not found in descendent

Return -1

end function

public function integer of_SetFileAttributes (string as_FileName, boolean ab_ReadOnly, boolean ab_Hidden, boolean ab_System, boolean ab_Archive);//	Function not found in descendent

Return -1

end function

public function integer of_GetFileAttributes (string as_filename, ref boolean ab_readonly, ref boolean ab_hidden, ref boolean ab_system, ref boolean ab_Subdirectory, ref boolean ab_archive);//	Function not found in descendent
...
public function string of_GetLongFilename (string as_AltFileName);//	Function not found in descendent

Return ""

end function

public function string of_GetAltFilename (string as_LongFileName);//	Function not found in descendent

Return ""

end function

public function double of_GetFileSize (string as_filename);//	Function not found in descendent
...
public function integer of_GetLastwriteDatetime (string as_filename, ref date ad_date, ref time at_time);//	Function not found in descendent

Return -1

end function

public function integer of_GetCreationDatetime (string as_filename, ref date ad_date, ref time at_time);//	Function not found in descendent
...
public function integer of_getlastaccessdate (string as_filename, ref date ad_date);//	Function not found in descendent

Return -1

end function

public function integer of_SetLastwriteDatetime (string as_filename, date ad_date, time at_time);//	Function not found in descendent

Return -1

end function

public function integer of_setcreationdatetime (string as_FileName, date ad_FileDate, time at_FileTime);//	Function not found in descendent

Return -1

end function

public function integer of_setlastaccessdate (string as_filename, date ad_date);//	Function not found in descendent
...
Integer				li_Limit, li_Cnt, li_Pos, li_rc
long					ll_rowcount
...
// load datastore
li_limit = upperbound(anv_dirlist)
...
protected function integer of_dirattribtods (ref n_ds ads_source, n_cst_dirattrib anv_entry, string as_sortfilename, integer ai_filegroup);long	ll_row, ll_pos
...
protected function integer of_dstodirattrib (ref n_ds ads_source, ref n_cst_dirattrib anv_entry, long al_row);string	ls_readonly, ls_hidden, ls_subdir, ls_archive, ls_drive, ls_system
...
public function integer of_getdrivetype (string as_drive);//	Function not found in descendent

Return -1

end function

public function integer of_getdiskspace (string as_drive, ref long al_totalspace, ref long al_freespace);//	Function not found in descendent
...
public function string of_getallfilesspecifier ();//////////////////////////////////////////////////////////////////////////////
//
//	Function:  of_GetAllFilesSpecifier
//
//	Access:  public
//
//	Arguments:	None.
