...
this.Control[iCurrent+1]=gb_column
this.Control[iCurrent+2]=dw_requestorview
this.Control[iCurrent+3]=st_rownumber_t
this.Control[iCurrent+4]=st_rowstatus
this.Control[iCurrent+5]=st_columnname_t
this.Control[iCurrent+6]=st_columnstatus
this.Control[iCurrent+7]=ddlb_rowstatus
this.Control[iCurrent+8]=ddlb_columnstatus
this.Control[iCurrent+9]=st_rownumber
this.Control[iCurrent+10]=st_columnname
this.Control[iCurrent+11]=cbx_assistrow
this.Control[iCurrent+12]=gb_row
end on
