...
this.Control[iCurrent+1]=st_style
this.Control[iCurrent+2]=cbx_columnheader
this.Control[iCurrent+3]=cbx_visibleonly
this.Control[iCurrent+4]=cbx_usedisplayvalue
this.Control[iCurrent+5]=st_excludecols
this.Control[iCurrent+6]=ddlb_style
this.Control[iCurrent+7]=lb_excludecols
this.Control[iCurrent+8]=st_headersuffix
this.Control[iCurrent+9]=sle_headersuffix
end on
...
int Accelerator=115
string Item[]={"PowerScript Dialog",&
"Drag and Drop Dialog",&
"Simple Dialog",&
"DropDownListBox Dialog"}
end type
