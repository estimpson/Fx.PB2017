$PBExportHeader$pfc_u_tabpg_dwproperty_srvcalculator.sru
$PBExportComments$PFC DataWindow Property - The Calculator service tabpage
forward
...
this.Control[iCurrent+3]=dw_register
end on
