...
this.Control[iCurrent+1]=ddlb_table
this.Control[iCurrent+2]=st_table
this.Control[iCurrent+3]=lb_keycolumns
this.Control[iCurrent+4]=st_keycolumns
this.Control[iCurrent+5]=lb_updatecolumns
this.Control[iCurrent+6]=st_updatecolumns
this.Control[iCurrent+7]=cbx_register
this.Control[iCurrent+8]=rb_wherekey
this.Control[iCurrent+9]=rb_wherekeyandupd
this.Control[iCurrent+10]=rb_wherekeyandmod
this.Control[iCurrent+11]=rb_keydelthenins
this.Control[iCurrent+12]=rb_keyupdate
this.Control[iCurrent+13]=gb_1
...
int Y=280
int Width=645
string Text="Key and U&pdateable cols"
end type
...
int Width=571
boolean BringToTop=true
string Text="Key and &Modified cols"
end type
...
int Height=304
int TabOrder=30
string Text="Where clause for Upd/Del"
end type
