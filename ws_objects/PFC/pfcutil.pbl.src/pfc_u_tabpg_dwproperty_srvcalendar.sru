$PBExportHeader$pfc_u_tabpg_dwproperty_srvcalendar.sru
...
this.Control[iCurrent+1]=cbx_initialvalue
this.Control[iCurrent+2]=cbx_closeonclick
this.Control[iCurrent+3]=cbx_closeondoubleclick
this.Control[iCurrent+4]=dw_register
this.Control[iCurrent+5]=cbx_alwaysredraw
end on
