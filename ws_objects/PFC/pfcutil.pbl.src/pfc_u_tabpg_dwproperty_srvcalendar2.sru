$PBExportHeader$pfc_u_tabpg_dwproperty_srvcalendar2.sru
...
this.Control[iCurrent+1]=cbx_boldsaturdays
this.Control[iCurrent+2]=cbx_boldsundays
this.Control[iCurrent+3]=cbx_boldholidays
this.Control[iCurrent+4]=cbx_boldmarkeddays
this.Control[iCurrent+5]=dw_holidays
this.Control[iCurrent+6]=dw_markeddays
this.Control[iCurrent+7]=em_colorsaturday
this.Control[iCurrent+8]=st_colorsaturdary
this.Control[iCurrent+9]=em_colorsunday
this.Control[iCurrent+10]=st_colorsunday
this.Control[iCurrent+11]=em_colorholiday
this.Control[iCurrent+12]=st_colorholiday
this.Control[iCurrent+13]=em_colormarkedday
this.Control[iCurrent+14]=st_colormarkedday
this.Control[iCurrent+15]=gb_holiday
this.Control[iCurrent+16]=gb_markedday
this.Control[iCurrent+17]=gb_saturday
this.Control[iCurrent+18]=gb_sunday
end on
