$PBExportHeader$pfc_u_tabpg_dwproperty_srvquerymode.sru
...
this.Control[iCurrent+1]=cbx_enabled
this.Control[iCurrent+2]=st_columns
this.Control[iCurrent+3]=lb_cols
this.Control[iCurrent+4]=cbx_resetcriteria
this.Control[iCurrent+5]=cbx_retrieveondisabled
end on
...
int Height=60
boolean BringToTop=true
string Text="Highlight column which allow entry in QueryMode"
end type
