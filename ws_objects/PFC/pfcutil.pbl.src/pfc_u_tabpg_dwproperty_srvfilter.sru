$PBExportHeader$pfc_u_tabpg_dwproperty_srvfilter.sru
...
this.Control[iCurrent+2]=cbx_visibleonly
this.Control[iCurrent+3]=st_excludecols
this.Control[iCurrent+4]=ddlb_style
this.Control[iCurrent+5]=lb_excludecols
end on
