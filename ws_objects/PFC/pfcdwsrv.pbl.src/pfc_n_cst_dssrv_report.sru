...
Else
	...
	If Not IsNumber(ls_OldBorder) Then
...
String			ls_Modify, ls_Objects[], ls_Undo, ls_Type, ls_BackMode, ls_Return
Long				ll_Color
Integer			li_NumObjects, li_Count, li_Undo
n_cst_string	lnv_String
...
Else
	...
	Choose Case ls_Type
		Case "line"
			ll_Color = Long(ids_requestor.Describe(as_Name + ".Background.Color"))
			If Not IsNull(al_BackColor) And ll_Color <> al_BackColor Then
				ls_Modify = ls_Modify + " " + as_Name + ".Background.Color='" + String(al_BackColor) + "'"
				ls_Undo = ls_Undo + " " + as_Name + ".Background.Color='" + String(ll_Color) + "'"
				...
				End if
			End if
			ll_Color = Long(ids_requestor.Describe(as_Name + ".Pen.Color"))
			If Not IsNull(al_Color) And ll_Color <> al_Color Then
				ls_Modify = ls_Modify + " " + as_Name + ".Pen.Color='" + String(al_Color) + "'"
				ls_Undo = ls_Undo + " " + as_Name + ".Pen.Color='" + String(ll_Color) + "'"
			End if
		...
		Case "elipse", "rectangle", "roundrectangle"
			...
			If Not IsNull(al_BackColor) And ll_Color <> al_BackColor Then
				...
				End if
			End if
			ll_Color = Long(ids_requestor.Describe(as_Name + ".Brush.Color"))
			If Not IsNull(al_Color) And ll_Color <> al_Color Then
				ls_Modify = ls_Modify + " " + as_Name + ".Brush.Color='" + String(al_Color) + "'"
				ls_Undo = ls_Undo + " " + as_Name + ".Brush.Color='" + String(ll_Color) + "'"
			End if
		...
		Case "column", "compute", "text"
			...
			If Not IsNull(al_BackColor) And ll_Color <> al_BackColor Then
				...
				End if
			End if
			ll_Color = Long(ids_requestor.Describe(as_Name + ".Color"))
			If Not IsNull(al_Color) And ll_Color <> al_Color Then
				ls_Modify = ls_Modify + " " + as_Name + ".Color='" + String(al_Color) + "'"
				ls_Undo = ls_Undo + " " + as_Name + ".Color='" + String(ll_Color) + "'"
			End if
	End Choose
