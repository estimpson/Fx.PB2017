...
//
//	Arguments:
//		al_prevrow	The previous row.
//		al_newrow	The new row.
//
//	Returns:  integer
//	 1 if the rowchange functionality should continue.
//	 0 if the rowchange functionality should be prevented.
//	-1 error
//
//	Description:	
//	Notification that row focus is changing.  Determine if focus going to another
...
// Check if the results of the retrieve should be filtered.
If ii_collinkuse = 1 Then
...
// 6.0   Function is no longer used by service.  Absoleted.
//
//////////////////////////////////////////////////////////////////////////////
//
//	Copyright © 1996-1997 Sybase, Inc. and its subsidiaries.  All rights reserved.
...
If IsValid(gnv_app.inv_debug) Then
	If IsValid(gnv_app.inv_debug.inv_sqlspy) Then
		...
		//Create the heading and message for the SQLSpy.
		ls_sqlspyheading = idw_requestor.ClassName() + '.Linkage'
		ls_sqlspymessage = 'Update dual-pass - 2nd pass ToDown (inserts/deletes)'
