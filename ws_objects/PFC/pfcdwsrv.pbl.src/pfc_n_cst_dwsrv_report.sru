...
Else
	...
	Choose Case ls_Type
		Case "line"
			ll_Color = Long(idw_Requestor.Describe(as_Name + ".Background.Color"))
			If Not IsNull(al_BackColor) And ll_Color <> al_BackColor Then
				...
				End if
			End if
			ll_Color = Long(idw_Requestor.Describe(as_Name + ".Pen.Color"))
		...
		Case "elipse", "rectangle", "roundrectangle"
			...
			If Not IsNull(al_BackColor) And ll_Color <> al_BackColor Then
				...
				End if
			End if
			ll_Color = Long(idw_Requestor.Describe(as_Name + ".Brush.Color"))
			If Not IsNull(al_Color) And ll_Color <> al_Color Then
		...
		Case "column", "compute", "text"
			...
			If Not IsNull(al_BackColor) And ll_Color <> al_BackColor Then
				...
				End if
			End if
			ll_Color = Long(idw_Requestor.Describe(as_Name + ".Color"))
			If Not IsNull(al_Color) And ll_Color <> al_Color Then
