$PBExportHeader$n_emp_trans.sru
forward
global type n_emp_trans from n_cst_fxtrans
end type
end forward

global type n_emp_trans from n_cst_fxtrans
end type
global n_emp_trans n_emp_trans
...
declare Proc1 procedure for dbo.usp_EMP_Proc1
	@Operator = :user
...
declare Proc2 procedure for dbo.usp_EMP_Proc2
	@Operator = :user
,	@TranDT = :tranDT output
,	@Result =:procResult output using TransObject  ;
...
on n_emp_trans.create
call super::create
end on

on n_emp_trans.destroy
call super::destroy
end on
