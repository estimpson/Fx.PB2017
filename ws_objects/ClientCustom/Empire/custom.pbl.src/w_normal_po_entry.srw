...
forward
global type w_normal_po_entry from Window
end type
...
string	ls_vstatus, ls_vendorcode
...
event start_to_print_po;st_print_preview_generic l_st_parm
...
ls_date			= Left ( ast_parm.value3, Len (ast_parm.value3 ) - 9 ) 
ls_time			= Right ( ast_parm.value3, 8 )  
...
event activate;If wmainscreen.MenuName <> "m_normal_po_entry" Then &
	wmainscreen.ChangeMenu ( m_normal_po_entry )
