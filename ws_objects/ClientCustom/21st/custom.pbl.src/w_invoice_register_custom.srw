$PBExportHeader$w_invoice_register_custom.srw
$PBExportComments$Custom Invoice Register for Grobbel
forward
global type w_invoice_register_custom from w_sheet_4t
end type
type dw_6 from datawindow within w_invoice_register_custom
end type
type cb_4 from commandbutton within w_invoice_register_custom
end type
type cb_3 from commandbutton within w_invoice_register_custom
end type
type cb_2 from commandbutton within w_invoice_register_custom
end type
type dw_5 from datawindow within w_invoice_register_custom
end type
type cb_1 from commandbutton within w_invoice_register_custom
end type
type cb_5 from commandbutton within w_invoice_register_custom
end type
type dw_4 from datawindow within w_invoice_register_custom
end type
type cb_6 from commandbutton within w_invoice_register_custom
end type
type dw_3 from datawindow within w_invoice_register_custom
end type
type dw_2 from datawindow within w_invoice_register_custom
end type
type st_2 from statictext within w_invoice_register_custom
end type
type em_2 from editmask within w_invoice_register_custom
end type
type st_1 from statictext within w_invoice_register_custom
end type
type em_1 from editmask within w_invoice_register_custom
end type
type dw_1 from datawindow within w_invoice_register_custom
end type
end forward
...
global w_invoice_register_custom w_invoice_register_custom
...
dw_1.Print ( )
dw_1.Modify("DataWindow.Print.Orientation = 0")
dw_4.Print ( )
end event
...
For lRow = 1 to dw_2.RowCount ( )
	...
	For lDetailRow = 1 to dw_3.RowCount ( )
		...
		dInvoiceAmount = dInvoiceAmount + ( dQty * dPrice ) + dTaxAmount
...
on w_invoice_register_custom.create
int iCurrent
call super::create
...
on w_invoice_register_custom.destroy
call super::destroy
...
on clicked;w_invoice_register_custom.TriggerEvent ( "generate_report" )
end on
