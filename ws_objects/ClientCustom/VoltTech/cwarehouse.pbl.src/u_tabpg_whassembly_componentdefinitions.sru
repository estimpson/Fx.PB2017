$PBExportHeader$u_tabpg_whassembly_componentdefinitions.sru
forward
global type u_tabpg_whassembly_componentdefinitions from u_tabpg_dw
end type
type cbx_showall from checkbox within u_tabpg_whassembly_componentdefinitions
end type
type cb_new from commandbutton within u_tabpg_whassembly_componentdefinitions
end type
type cb_save from commandbutton within u_tabpg_whassembly_componentdefinitions
end type
end forward
...
global u_tabpg_whassembly_componentdefinitions u_tabpg_whassembly_componentdefinitions
...
on u_tabpg_whassembly_componentdefinitions.create
int iCurrent
call super::create
...
on u_tabpg_whassembly_componentdefinitions.destroy
call super::destroy
...
type gb_1 from u_tabpg_dw`gb_1 within u_tabpg_whassembly_componentdefinitions
string text = "Component Definitions"
end type

type dw_1 from u_tabpg_dw`dw_1 within u_tabpg_whassembly_componentdefinitions
