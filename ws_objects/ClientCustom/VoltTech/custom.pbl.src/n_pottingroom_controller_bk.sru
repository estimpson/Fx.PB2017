$PBExportHeader$n_pottingroom_controller_bk.sru
forward
global type n_pottingroom_controller_bk from n_cst_virtual_controller
end type
end forward

global type n_pottingroom_controller_bk from n_cst_virtual_controller
end type
global n_pottingroom_controller_bk n_pottingroom_controller_bk
...
//if	_pottingRoomTrans.CheckKanban(_pottingRoomMachineCode, kanbanBinNumber, _operatorPottingRoom, isLoadable, hasInputContents, isUnloadable, isEmptyOrSameOperator, outputWorkOrderNumber, outputWorkOrderDetailLineNo, outputJobId) <> SUCCESS then
//	return FAILURE
//end if
...
on n_pottingroom_controller_bk.create
call super::create
end on

on n_pottingroom_controller_bk.destroy
call super::destroy
end on
