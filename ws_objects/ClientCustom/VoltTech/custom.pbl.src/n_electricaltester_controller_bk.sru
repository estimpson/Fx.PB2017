$PBExportHeader$n_electricaltester_controller_bk.sru
forward
global type n_electricaltester_controller_bk from n_cst_virtual_controller
end type
end forward

global type n_electricaltester_controller_bk from n_cst_virtual_controller
end type
global n_electricaltester_controller_bk n_electricaltester_controller_bk
...
on n_electricaltester_controller_bk.create
call super::create
end on

on n_electricaltester_controller_bk.destroy
call super::destroy
end on
