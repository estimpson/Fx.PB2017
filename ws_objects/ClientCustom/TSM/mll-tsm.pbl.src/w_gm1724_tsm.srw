$PBExportHeader$w_gm1724_tsm.srw
forward
global type w_gm1724_tsm from Window
end type
end forward
...
global w_gm1724_tsm w_gm1724_tsm
...
INTEGER i_julianDate,s_shipper, i_numberoflabels
...
//Select copies
//Into :i_NumberofLabels
//From report_library
//Where object_name = 'w_gm1724_tsm'  ;
//
//s_numberoflabels = "Q" + STRING ( i_numberoflabels )
...
PrintSend ( l_l_Label, c_esc + "H920" + c_esc + "V260" + c_esc + "$A,110,145,0" + c_esc + "$=" + s_linefeed )
...
PrintSend ( l_l_Label, c_esc + "H920" + c_esc + "V410" + c_esc + "$A,110,145,0" + c_esc + "$=" + s_dockcode )
...
on w_gm1724_tsm.create
end on

on w_gm1724_tsm.destroy
end on
