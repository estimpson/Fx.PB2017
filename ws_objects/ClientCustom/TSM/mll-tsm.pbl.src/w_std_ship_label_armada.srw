$PBExportHeader$w_std_ship_label_armada.srw
forward
global type w_std_ship_label_armada from Window
end type
type st_1 from statictext within w_std_ship_label_armada
end type
type em_1 from editmask within w_std_ship_label_armada
end type
type cb_1 from commandbutton within w_std_ship_label_armada
end type
end forward
...
global w_std_ship_label_armada w_std_ship_label_armada

on w_std_ship_label_armada.create
...
on w_std_ship_label_armada.destroy
destroy(this.st_1)
destroy(this.em_1)
destroy(this.cb_1)
end on
...
on clicked;//Script : open for w_std_ship_label
...
l_i_no = Integer ( em_1.text )
	...
	Printsend ( ll_Label, cEsc + "V080" + cEsc + "H1200" + cEsc + "s" + string ( l_i_no ) + " of " + string(em_1.text ) )

  //	Lower Box Data
  PrintSend ( ll_Label, cEsc + "V430" + cEsc + "H340" + cEsc + "M" + "TO:" )
  PrintSend ( ll_Label, cEsc + "V460" + cEsc + "H335" + cEsc + "$A,75,75,0" + cEsc + "$=" + szDestination )
  PrintSend ( ll_Label, cEsc + "V535" + cEsc + "H335" + cEsc + "$A,75,75,0" + cEsc + "$=" + szAddress4 )
  PrintSend ( ll_Label, cEsc + "V610" + cEsc + "H335" + cEsc + "$A,75,75,0" + cEsc + "$=" + szAddress5 )
  PrintSend ( ll_Label, cEsc + "V685" + cEsc + "H335" + cEsc + "$A,75,75,0" + cEsc + "$=" + szAddress6 )
