$PBExportHeader$w_mpl_chrysler.srw
forward
global type w_mpl_chrysler from Window
end type
end forward
...
global w_mpl_chrysler w_mpl_chrysler
...
on w_mpl_chrysler.create
end on

on w_mpl_chrysler.destroy
end on
