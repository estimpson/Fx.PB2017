$PBExportHeader$u_tabpg_lot_trace_topdown.sru
forward
global type u_tabpg_lot_trace_topdown from u_tabpg_dw
end type
type cb_1 from commandbutton within u_tabpg_lot_trace_topdown
end type
type cb_2 from commandbutton within u_tabpg_lot_trace_topdown
end type
type tv_1 from treeview within u_tabpg_lot_trace_topdown
end type
type st_1 from statictext within u_tabpg_lot_trace_topdown
end type
type st_split from u_st_splitbar within u_tabpg_lot_trace_topdown
end type
type dw_2 from u_fxdw within u_tabpg_lot_trace_topdown
end type
type gb_2 from groupbox within u_tabpg_lot_trace_topdown
end type
type gb_tree from groupbox within u_tabpg_lot_trace_topdown
end type
type st_vsplit1 from u_st_splitbar within u_tabpg_lot_trace_topdown
end type
type dw_3 from u_fxdw within u_tabpg_lot_trace_topdown
end type
type gb_3 from groupbox within u_tabpg_lot_trace_topdown
end type
type st_vsplit2 from u_st_splitbar within u_tabpg_lot_trace_topdown
end type
type uo_action_remaininginventory from u_action_remaininginventory within u_tabpg_lot_trace_topdown
end type
type uo_action_receipts from u_action_receipts within u_tabpg_lot_trace_topdown
end type
type cb_3 from commandbutton within u_tabpg_lot_trace_topdown
end type
end forward
...
uo_action_receipts uo_action_receipts
cb_3 cb_3
end type
global u_tabpg_lot_trace_topdown u_tabpg_lot_trace_topdown
...
if	_trans.TraceBackward_GetTreeItems(_traceNumber, hierarchID, treeItems) = SUCCESS then
...
public function integer refreshtrace ();
return _myController.RefreshTraceDown()

end function

on u_tabpg_lot_trace_topdown.create
int iCurrent
call super::create
...
this.uo_action_receipts=create uo_action_receipts
...
this.Control[iCurrent+14]=this.uo_action_receipts
this.Control[iCurrent+15]=this.cb_3
end on

on u_tabpg_lot_trace_topdown.destroy
call super::destroy
destroy(this.cb_1)
destroy(this.cb_2)
destroy(this.tv_1)
...
destroy(this.uo_action_receipts)
destroy(this.cb_3)
end on
...
inv_Resize.of_Register(uo_action_receipts, 100, 100, 0, 0)
...
type gb_1 from u_tabpg_dw`gb_1 within u_tabpg_lot_trace_topdown
integer x = 1129
integer height = 452
string text = "History"
end type

type dw_1 from u_tabpg_dw`dw_1 within u_tabpg_lot_trace_topdown
integer x = 1138
integer height = 364
string dataobject = "d_lot_trace_td_sourcedetails"
...
string picturename[] = {"alphab.bmp","alphac.bmp","alphad.bmp","alphaj.bmp","alphao.bmp","alpham.bmp","alphar.bmp"}
...
integer taborder = 11
boolean bringtotop = true
string dataobject = "d_lot_trace_td_receiptdetails"
boolean showcolumncomments = false
end type
...
of_Register(uo_action_receipts, BELOW)
...
integer taborder = 21
boolean bringtotop = true
string dataobject = "d_lot_trace_td_remaininginventory"
boolean showcolumncomments = false
end type
...
of_Register(uo_action_receipts, ABOVE)
...
on uo_action_receipts.destroy
call u_action_receipts::destroy
end on
