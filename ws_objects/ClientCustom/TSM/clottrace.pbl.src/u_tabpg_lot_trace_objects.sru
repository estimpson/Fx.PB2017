$PBExportHeader$u_tabpg_lot_trace_objects.sru
forward
global type u_tabpg_lot_trace_objects from u_tabpg_dw
end type
type cb_1 from commandbutton within u_tabpg_lot_trace_objects
end type
type cb_2 from commandbutton within u_tabpg_lot_trace_objects
end type
end forward
...
global u_tabpg_lot_trace_objects u_tabpg_lot_trace_objects
...
on u_tabpg_lot_trace_objects.create
int iCurrent
call super::create
...
on u_tabpg_lot_trace_objects.destroy
call super::destroy
destroy(this.cb_1)
destroy(this.cb_2)
end on
...
type gb_1 from u_tabpg_dw`gb_1 within u_tabpg_lot_trace_objects
end type

type dw_1 from u_tabpg_dw`dw_1 within u_tabpg_lot_trace_objects
