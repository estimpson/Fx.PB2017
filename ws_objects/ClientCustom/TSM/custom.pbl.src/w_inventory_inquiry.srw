$PBExportHeader$w_inventory_inquiry.srw
forward
...
global w_inventory_inquiry w_inventory_inquiry
...
if	pType = 'W' then
	MsgBox("You cannot correct WIP inventory from here.  Perform a cycle count.")
	return
elseif	pType = 'F' then
	MsgBox("You cannot correct finished inventory from here.  Perform a cycle count.")
	return
end if
...
on w_inventory_inquiry.destroy
call super::destroy
...
type dw_inquiry from w_inquiry_ancestor`dw_inquiry within w_inventory_inquiry
