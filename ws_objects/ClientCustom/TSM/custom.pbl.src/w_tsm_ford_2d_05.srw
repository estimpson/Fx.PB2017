$PBExportHeader$w_tsm_ford_2d_05.srw
forward
global type w_tsm_ford_2d_05 from w_label_base
end type
end forward

global type w_tsm_ford_2d_05 from w_label_base
end type
global w_tsm_ford_2d_05 w_tsm_ford_2d_05
...
//////////////////////////////////////////////////////////////////////////////////////////
//
//	window		: w_tsm_ford_2d_05 inherited from base
//	
...
if not lb_mixedload then
	// Weight, Container
	if isnull(is_type,'') = 'S' then // master
...
// Custom for FM Windsor
select	date_stamp
into		:ldt_ship_date
from		shipper
where		shipper.id = :il_shipper ;
...
//ls_2d_data = ls_2d_data + ls_gs + "D" + upper ( string ( ldt_ship_date, "yymmdd" ) )
//if is_dockcode > "" then
...
//	PrintSend ( ll_Label, ls_esc + "V154" + ls_esc + "H645" + ls_esc + "$B,46,65,0" + ls_esc + "$=" + ls_packagetype)
...
//PrintSend ( ll_Label, ls_esc + "V280" + ls_esc + "H645" + ls_esc + "$B,46,65,0" + ls_esc + "$=" + upper ( string ( ldt_ship_date, "ddmmmyyyy" ) ) )
//
//// Part
//if not lb_mixedload then
...
on w_tsm_ford_2d_05.create
call super::create
end on

on w_tsm_ford_2d_05.destroy
call super::destroy
end on
