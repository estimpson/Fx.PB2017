$PBExportHeader$w_std_label_for_raw.srw
$PBExportComments$Label for standard label for raw
forward
global type w_std_label_for_raw from Window
end type
end forward
...
global w_std_label_for_raw w_std_label_for_raw
...
PrintSend ( ll_Label, cEsc + "V100" + cEsc + "H350" + cEsc + "$A,200,100,0" + cEsc + "$=" + szPart )
...
PrintSend ( ll_Label, cEsc + "V560" + cEsc + "H350" + cEsc + "$A,110,100,0" + cEsc + "$=" + String(lserial) )
PrintSend ( ll_Label, cEsc + "V718" + cEsc + "H346" + cEsc + "B102095" + "*" + "S" + String ( lSerial ) + "*" )
PrintSend ( ll_Label, cEsc + "V300" + cEsc + "H1070" + cEsc + "$A,125,100,0" + cEsc + "$=" + "R A W" )
...
on w_std_label_for_raw.create
end on

on w_std_label_for_raw.destroy
end on
