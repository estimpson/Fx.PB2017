$PBExportHeader$w_tsm_npg_container.srw
forward
global type w_tsm_npg_container from w_label_base
end type
end forward

global type w_tsm_npg_container from w_label_base
end type
global w_tsm_npg_container w_tsm_npg_container
...
on w_tsm_npg_container.create
call super::create
end on

on w_tsm_npg_container.destroy
call super::destroy
end on
...
PrintSend ( ll_Label, ls_esc + "V026" + ls_esc + "H1220" + ls_esc + "$B,50,120,0"  + ls_esc + "$=SINGLE"  )
PrintSend ( ll_Label, ls_esc + "V130" + ls_esc + "H1220" + ls_esc + "$B,50,120,0"  + ls_esc + "$=PACK"  )
...
ls_serial = "3S"+trim(ls_seril)

//	Serial Number Info
PrintSend ( ll_Label, ls_esc + "V640" + ls_esc + "H250" + ls_esc + "L0101" + ls_esc + "M" + "SERIAL " )
PrintSend ( ll_Label, ls_esc + "V665" + ls_esc + "H250" + ls_esc + "L0101" + ls_esc + "M" + "(3S)" )
