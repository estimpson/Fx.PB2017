$PBExportHeader$w_tsm_pallet_label_selector.srw
forward
global type w_tsm_pallet_label_selector from window
end type
end forward
...
global w_tsm_pallet_label_selector w_tsm_pallet_label_selector
...
on w_tsm_pallet_label_selector.create
end on

on w_tsm_pallet_label_selector.destroy
end on
