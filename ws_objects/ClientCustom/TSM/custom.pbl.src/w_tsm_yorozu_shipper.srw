$PBExportHeader$w_tsm_yorozu_shipper.srw
forward
global type w_tsm_yorozu_shipper from window
end type
end forward
...
global w_tsm_yorozu_shipper w_tsm_yorozu_shipper
...
on w_tsm_yorozu_shipper.create
end on

on w_tsm_yorozu_shipper.destroy
end on
