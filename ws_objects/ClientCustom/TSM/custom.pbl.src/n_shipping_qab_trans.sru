$PBExportHeader$n_shipping_qab_trans.sru
forward
global type n_shipping_qab_trans from n_cst_fxtrans
end type
end forward

global type n_shipping_qab_trans from n_cst_fxtrans
end type
global n_shipping_qab_trans n_shipping_qab_trans
...
declare Proc1 procedure for dbo.usp_Shipping_QAB_Proc1
	@Operator = :user
...
declare Proc2 procedure for dbo.usp_Shipping_QAB_Proc2
	@Operator = :user
,	@SomeValue = :someValue
,	@TranDT = :tranDT output
,	@Result =:procResult output using TransObject  ;
...
on n_shipping_qab_trans.create
call super::create
end on

on n_shipping_qab_trans.destroy
call super::destroy
end on
