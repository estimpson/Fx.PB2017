$PBExportHeader$w_tsm_cooper_container.srw
forward
global type w_tsm_cooper_container from Window
end type
end forward
...
global w_tsm_cooper_container w_tsm_cooper_container
...
PrintSend ( ll_Label, cEsc + "V305" + cEsc + "H305" + cEsc + "B103101" + "*" +"Q" + String(dQuantity) + "*" )
...
PrintSend ( ll_Label, cEsc + "V650" + cEsc + "H270" + cEsc + "L0101" + cEsc + "M" + "(S)" )
//PrintSend ( ll_Label, cEsc + "V625" + cEsc + "H400" + cEsc + "L0101" + cEsc + "WL1" + String(lSerial))
//PrintSend ( ll_Label, cEsc + "V673" + cEsc + "H305" + cEsc + "B103100" + "*" + "S" + String(lSerial) + "*")
szSerial = right(('000000000' + string(lSerial)), 9)
PrintSend ( ll_Label, cEsc + "V625" + cEsc + "H400" + cEsc + "L0101" + cEsc + "WL1" + szSerial)
PrintSend ( ll_Label, cEsc + "V673" + cEsc + "H305" + cEsc + "B103100" + "*" + "S" + szSerial + "*")
...
PrintSend ( ll_Label, cEsc + "V790" + cEsc + "H1175" + cEsc + "L0101" + cEsc + "S" + 'COOPERT' )
...
on w_tsm_cooper_container.create
end on

on w_tsm_cooper_container.destroy
end on
