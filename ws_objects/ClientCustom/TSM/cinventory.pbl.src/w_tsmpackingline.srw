$PBExportHeader$w_tsmpackingline.srw
forward
global type w_tsmpackingline from w_sheet_headerdetail_4t
end type
...
global w_tsmpackingline w_tsmpackingline

on w_tsmpackingline.create
int iCurrent
call super::create
...
on w_tsmpackingline.destroy
call super::destroy
if IsValid(MenuID) then destroy(MenuID)
end on

type tab_1 from w_sheet_headerdetail_4t`tab_1 within w_tsmpackingline
tabpage_1 tabpage_1
end type
...
type tab_2 from w_sheet_headerdetail_4t`tab_2 within w_tsmpackingline
tabpage_2 tabpage_2
tabpage_3 tabpage_3
tabpage_4 tabpage_4
end type
...
type st_1 from w_sheet_headerdetail_4t`st_1 within w_tsmpackingline
end type
