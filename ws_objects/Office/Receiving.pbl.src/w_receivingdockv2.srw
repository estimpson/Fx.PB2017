$PBExportHeader$w_receivingdockv2.srw
forward
...
public function long getactivereceiverid ();
long receiverID
Controller.GetActiveReceiverID(receiverID)
return receiverID
...
if this.MenuName = "m_receivingv2" then this.MenuID = create m_receivingv2
