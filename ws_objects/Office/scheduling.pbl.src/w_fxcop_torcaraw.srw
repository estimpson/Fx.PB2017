$PBExportHeader$w_fxcop_torcaraw.srw
forward
global type w_fxcop_torcaraw from w_sheet_headerdetail_4t
end type
...
type p_smalllogo from picture within w_fxcop_torcaraw
end type
type p_banner from picture within w_fxcop_torcaraw
end type
end forward
...
global w_fxcop_torcaraw w_fxcop_torcaraw

on w_fxcop_torcaraw.create
int iCurrent
call super::create
...
type tab_1 from w_sheet_headerdetail_4t`tab_1 within w_fxcop_torcaraw
integer y = 336
...
type tab_2 from w_sheet_headerdetail_4t`tab_2 within w_fxcop_torcaraw
integer y = 1524
tabpage_2 tabpage_2
tabpage_3 tabpage_3
tabpage_4 tabpage_4
...
type st_1 from w_sheet_headerdetail_4t`st_1 within w_fxcop_torcaraw
integer y = 1504
end type
...
integer width = 1925
integer height = 224
string picturename = "sheetBanner.RawMaterialScheduling.jpg"
boolean focusrectangle = false
end type
