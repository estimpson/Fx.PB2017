$PBExportHeader$w_ppimoldingmachineschedule.srw
forward
global type w_ppimoldingmachineschedule from w_sheet_headerdetail_4t
end type
...
global w_ppimoldingmachineschedule w_ppimoldingmachineschedule

on w_ppimoldingmachineschedule.create
int iCurrent
call super::create
...
on w_ppimoldingmachineschedule.destroy
call super::destroy
...
type tab_1 from w_sheet_headerdetail_4t`tab_1 within w_ppimoldingmachineschedule
...
type tab_2 from w_sheet_headerdetail_4t`tab_2 within w_ppimoldingmachineschedule
...
type st_1 from w_sheet_headerdetail_4t`st_1 within w_ppimoldingmachineschedule
end type
