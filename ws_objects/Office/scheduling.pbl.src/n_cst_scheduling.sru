$PBExportHeader$n_cst_scheduling.sru
forward
global type n_cst_scheduling from n_tr
end type
end forward
...
global n_cst_scheduling n_cst_scheduling

forward prototypes
public function integer schedulenextbuild (ref string workordernumber, string user, string machinecode, string toolcode, string processcode, string partcode, decimal nextbuildqty, datetime duedt, string toppart, integer salesorderno, string shiptocode, string billtocode, ref long procresult, boolean commitnow)
end prototypes
...
on n_cst_scheduling.create
call super::create
end on

on n_cst_scheduling.destroy
call super::destroy
end on
