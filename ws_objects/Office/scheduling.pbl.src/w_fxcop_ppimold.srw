$PBExportHeader$w_fxcop_ppimold.srw
forward
global type w_fxcop_ppimold from w_sheet_headerdetail_4t
end type
type tabpage_summary from u_tabpg_fxcop_ppimolding within tab_1
end type
type tabpage_summary from u_tabpg_fxcop_ppimolding within tab_1
end type
...
type p_smalllogo from picture within w_fxcop_ppimold
end type
type p_banner from picture within w_fxcop_ppimold
end type
end forward

global type w_fxcop_ppimold from w_sheet_headerdetail_4t
integer height = 2552
string title = "Molding Schedule"
string menuname = "m_sheet_4t_updateablenew"
long backcolor = 0
p_smalllogo p_smalllogo
p_banner p_banner
end type
global w_fxcop_ppimold w_fxcop_ppimold

on w_fxcop_ppimold.create
int iCurrent
call super::create
...
type tab_1 from w_sheet_headerdetail_4t`tab_1 within w_fxcop_ppimold
integer y = 336
...
type tab_2 from w_sheet_headerdetail_4t`tab_2 within w_fxcop_ppimold
integer y = 1524
tabpage_2 tabpage_2
tabpage_3 tabpage_3
tabpage_4 tabpage_4
...
type st_1 from w_sheet_headerdetail_4t`st_1 within w_fxcop_ppimold
integer y = 1504
end type
...
integer height = 196
boolean originalsize = true
string picturename = "FX_MoldingSchedule.jpg"
boolean focusrectangle = false
end type
