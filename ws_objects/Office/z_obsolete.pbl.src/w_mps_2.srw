$PBExportHeader$w_mps_2.srw
forward
global type w_mps_2 from Window
end type
type st_11 from statictext within w_mps_2
end type
type pb_2 from picturebutton within w_mps_2
end type
type dw_vendors from datawindow within w_mps_2
end type
type dw_demand_per_part from datawindow within w_mps_2
end type
type dw_list_parts from datawindow within w_mps_2
end type
type dw_check_router from datawindow within w_mps_2
end type
type dw_stack from datawindow within w_mps_2
end type
type dw_part_mfg from datawindow within w_mps_2
end type
type dw_workorder_detail from datawindow within w_mps_2
end type
type dw_part_info from datawindow within w_mps_2
end type
type dw_product_line from datawindow within w_mps_2
end type
type ddlb_type_value from dropdownlistbox within w_mps_2
end type
type ddlb_type from dropdownlistbox within w_mps_2
end type
type st_1 from statictext within w_mps_2
end type
type st_label from statictext within w_mps_2
end type
type dw_machine_list_for_part from datawindow within w_mps_2
end type
type rb_7 from radiobutton within w_mps_2
end type
type rb_6 from radiobutton within w_mps_2
end type
type rb_5 from radiobutton within w_mps_2
end type
type rb_4 from radiobutton within w_mps_2
end type
type rb_3 from radiobutton within w_mps_2
end type
type rb_2 from radiobutton within w_mps_2
end type
type rb_1 from radiobutton within w_mps_2
end type
type dw_list_parts_bom from datawindow within w_mps_2
end type
type dw_bom from datawindow within w_mps_2
end type
type dw_machine_process from datawindow within w_mps_2
end type
type dw_mps_in_work_order from datawindow within w_mps_2
end type
type dw_work_detail from datawindow within w_mps_2
end type
type dw_process_info from datawindow within w_mps_2
end type
type dw_current_demand from datawindow within w_mps_2
end type
type cbx_daily from checkbox within w_mps_2
end type
type dw_process_id from datawindow within w_mps_2
end type
type dw_part_online_info from datawindow within w_mps_2
end type
type cbx_time from checkbox within w_mps_2
end type
type cbx_onhand from checkbox within w_mps_2
end type
type st_10 from statictext within w_mps_2
end type
type st_name1 from statictext within w_mps_2
end type
type st_name7 from statictext within w_mps_2
end type
type st_name6 from statictext within w_mps_2
end type
type st_name5 from statictext within w_mps_2
end type
type st_name4 from statictext within w_mps_2
end type
type st_name3 from statictext within w_mps_2
end type
type st_name2 from statictext within w_mps_2
end type
type pb_1 from picturebutton within w_mps_2
end type
type st_9 from statictext within w_mps_2
end type
type st_8 from statictext within w_mps_2
end type
type st_7 from statictext within w_mps_2
end type
type st_6 from statictext within w_mps_2
end type
type st_5 from statictext within w_mps_2
end type
type st_4 from statictext within w_mps_2
end type
type st_3 from statictext within w_mps_2
end type
type st_2 from statictext within w_mps_2
end type
type dw_demand from datawindow within w_mps_2
end type
type dw_crosstab from datawindow within w_mps_2
end type
type dw_machine_list from datawindow within w_mps_2
end type
type dw_unscheduled_mps from datawindow within w_mps_2
end type
type dw_machine_load from datawindow within w_mps_2
end type
end forward
...
//	Else
//		Open(w_prompt_for_total_qty_in_schedule_new)
//	End If
//	bCrossTab = FALSE
//End If
//
...
Declare PartCur Cursor for Select Number, Type From Part Using sqlca;
...
For iRow	= 1 to dw_crosstab.RowCount()
	...
	w_mps_2.SetMicroHelp(szMicroHelp)
...
For iCol = 2 to 8
	dw_crosstab.SetItem(iCrossTabRow, iCol, 0)
Next
...
on clicked;Parent.TriggerEvent("rebuild_crosstab")
end on
...
on selectionchanged;Choose Case ddlb_type.text
	Case "All Parts"
		iSelection	= 1
...
on clicked;open (w_select_view_mps_date)
end on
...
//			assigne_sequence()
//			dw_machine_load.Retrieve(szMachine)
//			Undo_mps_in_workorder(szWorkOrder)
...
If iRow > 0 and iCol > 1 and iCol <= 9 then
	...
	If f_get_activity(szPart) <> "OUTSIDE" then
		...
		w_mps_2.SetMicroHelp("Drag to machine for schedule")
		display_related_machines(szPart)
		bOutside	= FALSE
	Else
		st_label.text	= "Availabel vendors:"
		w_mps_2.SetMicroHelp("Drag to vendor for outside process")
		bOutside	= TRUE	
...
on dragdrop;//If bCrossTab then
//	Open(w_prompt_for_total_qty_in_schedule)
//	bCrossTab = FALSE
//End If
//
//
