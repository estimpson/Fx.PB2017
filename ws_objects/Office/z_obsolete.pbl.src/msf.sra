$PBExportHeader$msf.sra
$PBExportComments$Shop Floor Module
forward
global n_tr sqlca
...
global type msf from application
 end type
global msf msf
...
l_s_machine = f_get_string_value ( CommandParm ( ) )
...
// Open MDI Frame
If l_s_machine <> "" Then
	OpenWithParm ( w_machine, l_s_machine )
Else
	Open ( w_msfw30_main )
End if
