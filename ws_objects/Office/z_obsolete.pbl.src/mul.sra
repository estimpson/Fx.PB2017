...
global type mul from application
 end type
global mul mul
...
monsys.title = "Monitor Utilities"
monsys.of_getidinfo ( )
liblist.app	 = this
...
// To display the rotating the logo..
...
// Set Toolbar Names
toolbarframetitle = "MONITOR UTILITIES"
toolbartext			= TRUE
