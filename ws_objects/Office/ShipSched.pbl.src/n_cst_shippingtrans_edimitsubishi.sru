$PBExportHeader$n_cst_shippingtrans_edimitsubishi.sru
forward
global type n_cst_shippingtrans_edimitsubishi from n_cst_fxtrans
end type
end forward

global type n_cst_shippingtrans_edimitsubishi from n_cst_fxtrans
end type
global n_cst_shippingtrans_edimitsubishi n_cst_shippingtrans_edimitsubishi
...
on n_cst_shippingtrans_edimitsubishi.create
call super::create
end on

on n_cst_shippingtrans_edimitsubishi.destroy
call super::destroy
end on
