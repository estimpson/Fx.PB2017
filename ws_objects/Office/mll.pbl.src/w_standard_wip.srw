$PBExportHeader$w_standard_wip.srw
forward
global type w_standard_wip from Window
end type
end forward
...
global w_standard_wip w_standard_wip
...
PrintSend ( ll_Label, cEsc + "V300" + cEsc + "H1020" + cEsc + "$A,125,100,0" + cEsc + "$=" + "W I P" )
PrintSend ( ll_Label, cEsc + "V570" + cEsc + "H1020" + cEsc + "WB1" + "LOCAT " + szLoc)
PrintSend ( ll_Label, cEsc + "V630" + cEsc + "H1020" + cEsc + "WB1" + "TIME  " + szTimes )
PrintSend ( ll_Label, cEsc + "V690" + cEsc + "H1020" + cEsc + "WB1" + "DATE  " + String(dDate) )
PrintSend ( ll_Label, cEsc + "V750" + cEsc + "H1020" + cEsc + "WB1" + "OPER  " + szOperator )
//
//  Draw Lines
...
on w_standard_wip.create
end on

on w_standard_wip.destroy
end on
