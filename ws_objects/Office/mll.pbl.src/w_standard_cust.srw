$PBExportHeader$w_standard_cust.srw
forward
global type w_standard_cust from w_label_base
end type
end forward

global type w_standard_cust from w_label_base
end type
global w_standard_cust w_standard_cust

on w_standard_cust.create
call super::create
end on

on w_standard_cust.destroy
call super::destroy
end on
