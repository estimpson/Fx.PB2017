$PBExportHeader$w_standard_raw.srw
forward
global type w_standard_raw from Window
end type
end forward
...
global w_standard_raw w_standard_raw
...
PrintSend ( ll_Label, cEsc + "V300" + cEsc + "H1020" + cEsc + "$A,125,100,0" + cEsc + "$=" + "R A W" )
...
on w_standard_raw.create
end on

on w_standard_raw.destroy
end on
