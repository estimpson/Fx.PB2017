$PBExportHeader$w_21cent_pallet.srw
forward
global type w_21cent_pallet from window
end type
end forward
...
global w_21cent_pallet w_21cent_pallet
...
PrintSend ( l_Label, c_Esc + "V800" + c_Esc + "H300" + c_Esc + "S" + szCompany + "  " + szAddress1 + " " + szAddress2 )
...
on w_21cent_pallet.create
end on

on w_21cent_pallet.destroy
end on
