$PBExportHeader$w_standard_fin.srw
forward
global type w_standard_fin from Window
end type
end forward
...
global w_standard_fin w_standard_fin
...
on w_standard_fin.create
end on

on w_standard_fin.destroy
end on
