$PBExportHeader$w_21cent_irwin.srw
forward
global type w_21cent_irwin from window
end type
end forward
...
global w_21cent_irwin w_21cent_irwin

type variables
st_generic_structure stparm
end variables

event open;//  custom label for irwin
//  21st Century 
//  csr 175149  4/20/04
//  Declaration
Dec {0}	dQuantity
...
// IF PO# NO START WITH LETTER THEN PUT 'P' IN IT
// You probably want IsNumber(string).  This returns TRUE if it is a number, so you can use it in the IF statement.

S_PO = MID(S_PoNumber, 1, 1)
if IsNumber(S_PO) then
	S_PoNumber = "P" + S_PoNumber
end if

//  Customer PO
PrintSend ( ll_Label, cEsc + "V295" + cEsc + "H855" + cEsc + "B103101" + "*" +"A" + S_PoNumber + "*" )
PrintSend ( ll_Label, cEsc + "V405" + cEsc + "H805" + cEsc + "L0101" + cEsc + "M" + "PO#" )
PrintSend ( ll_Label, cEsc + "V425" + cEsc + "H805" + cEsc + "L0101" + cEsc + "M" + "(A)" )
PrintSend ( ll_Label, cEsc + "V420" + cEsc + "H890" + cEsc + "L0101" + cEsc + "WL1" + s_PoNumber )
...
// LOCATION
PrintSend ( ll_Label, cEsc + "V495" + cEsc + "H805" + cEsc + "L0101" + cEsc + "M" + "LOCATION" )
PrintSend ( ll_Label, cEsc + "V525" + cEsc + "H805" + cEsc + "L0101" + cEsc + "M" + "(L)" )
PrintSend ( ll_Label, cEsc + "V525" + cEsc + "H890" + cEsc + "L0101" + cEsc + "WL1" + "U" )
PrintSend ( ll_Label, cEsc + "V503" + cEsc + "H995" + cEsc + "B103070" + "*" + "L" + "U" + "*"  )
...
on w_21cent_irwin.create
end on

on w_21cent_irwin.destroy
end on
