$PBExportHeader$w_21cent_allsteel.srw
$PBExportComments$21st Century Cust Label
forward
global type w_21cent_allsteel from window
end type
end forward
...
global w_21cent_allsteel w_21cent_allsteel
...
//  Engineering Change
PrintSend ( ll_Label, cEsc + "V748" + cEsc + "H855" + cEsc + "L0101" + cEsc + "M" + "Material" )
PrintSend ( ll_Label, cEsc + "V740" + cEsc + "H1020" + cEsc + "L0101" + cEsc + "WB1" + "LGA" )
...
on w_21cent_allsteel.create
end on

on w_21cent_allsteel.destroy
end on
