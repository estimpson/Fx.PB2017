$PBExportHeader$u_tabpg_outproc_maint_inventory_btb.sru
forward
global type u_tabpg_outproc_maint_inventory_btb from u_tabpg_dw
end type
type cb_1 from commandbutton within u_tabpg_outproc_maint_inventory_btb
end type
type cb_2 from commandbutton within u_tabpg_outproc_maint_inventory_btb
end type
type dw_2 from u_fxdw within u_tabpg_outproc_maint_inventory_btb
end type
type cb_3 from commandbutton within u_tabpg_outproc_maint_inventory_btb
end type
type gb_2 from groupbox within u_tabpg_outproc_maint_inventory_btb
end type
end forward

global type u_tabpg_outproc_maint_inventory_btb from u_tabpg_dw
integer width = 2414
string text = "Inventory (Back to Back)"
cb_1 cb_1
cb_2 cb_2
dw_2 dw_2
cb_3 cb_3
...
global u_tabpg_outproc_maint_inventory_btb u_tabpg_outproc_maint_inventory_btb
...
on u_tabpg_outproc_maint_inventory_btb.create
int iCurrent
call super::create
...
on u_tabpg_outproc_maint_inventory_btb.destroy
call super::destroy
destroy(this.cb_1)
destroy(this.cb_2)
destroy(this.dw_2)
...
type gb_1 from u_tabpg_dw`gb_1 within u_tabpg_outproc_maint_inventory_btb
integer y = 4
integer height = 428
string text = "Supplier Inventory"
end type

type dw_1 from u_tabpg_dw`dw_1 within u_tabpg_outproc_maint_inventory_btb
integer height = 344
...
_myController.ShowNewBTBShipment()
