$PBExportHeader$u_tabpg_surcharge_setups_categories.sru
forward
global type u_tabpg_surcharge_setups_categories from u_tabpg_dw
end type
type cb_1 from commandbutton within u_tabpg_surcharge_setups_categories
end type
type cb_2 from commandbutton within u_tabpg_surcharge_setups_categories
end type
type dw_quickgridmenu from u_fxdw_quickgridmenu within u_tabpg_surcharge_setups_categories
end type
end forward
...
global u_tabpg_surcharge_setups_categories u_tabpg_surcharge_setups_categories
...
on u_tabpg_surcharge_setups_categories.create
int iCurrent
call super::create
...
on u_tabpg_surcharge_setups_categories.destroy
call super::destroy
destroy(this.cb_1)
destroy(this.cb_2)
...
type gb_1 from u_tabpg_dw`gb_1 within u_tabpg_surcharge_setups_categories
string text = "Surcharge Categories"
end type

type dw_1 from u_tabpg_dw`dw_1 within u_tabpg_surcharge_setups_categories
