$PBExportHeader$u_tabpg_surcharge_setups_units.sru
forward
global type u_tabpg_surcharge_setups_units from u_tabpg_dw
end type
type cb_1 from commandbutton within u_tabpg_surcharge_setups_units
end type
type cb_2 from commandbutton within u_tabpg_surcharge_setups_units
end type
type dw_quickgridmenu from u_fxdw_quickgridmenu within u_tabpg_surcharge_setups_units
end type
end forward
...
global u_tabpg_surcharge_setups_units u_tabpg_surcharge_setups_units
...
on u_tabpg_surcharge_setups_units.create
int iCurrent
call super::create
...
on u_tabpg_surcharge_setups_units.destroy
call super::destroy
destroy(this.cb_1)
destroy(this.cb_2)
...
type gb_1 from u_tabpg_dw`gb_1 within u_tabpg_surcharge_setups_units
string text = "Units"
end type

type dw_1 from u_tabpg_dw`dw_1 within u_tabpg_surcharge_setups_units
