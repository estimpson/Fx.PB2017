$PBExportHeader$w_aztec_ford_1.srw
forward
global type w_aztec_ford_1 from Window
end type
end forward
...
global w_aztec_ford_1 w_aztec_ford_1
...
PrintSend ( l_Label, c_Esc + "V490" + c_Esc + "H900" + c_Esc + "$A,100,110,0" + c_Esc + "$=" + s_line_feed_code )
...
on w_aztec_ford_1.create
end on

on w_aztec_ford_1.destroy
end on
