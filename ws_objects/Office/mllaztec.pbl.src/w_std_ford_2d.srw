$PBExportHeader$w_std_ford_2d.srw
forward
global type w_std_ford_2d from w_label_base
end type
end forward

global type w_std_ford_2d from w_label_base
end type
global w_std_ford_2d w_std_ford_2d
...
// Address Info
PrintSend ( ll_Label, ls_esc + "V50" + ls_esc + "H220" + ls_esc + "L0101" + ls_esc + "M" + "FROM" )
PrintSend ( ll_Label, ls_esc + "V075" + ls_esc + "H220" + ls_esc + "L0101" + ls_esc + "M" + upper ( left ( is_company, 24 ) ) )
PrintSend ( ll_Label, ls_esc + "V100" + ls_esc + "H220" + ls_esc + "L0101" + ls_esc + "M" + upper ( left ( is_caddress1, 24 ) ) )
PrintSend ( ll_Label, ls_esc + "V125" + ls_esc + "H220" + ls_esc + "L0101" + ls_esc + "M" + upper ( left ( is_caddress2, 24 ) ) )
PrintSend ( ll_Label, ls_esc + "V150" + ls_esc + "H220" + ls_esc + "L0101" + ls_esc + "M" + upper ( left ( is_caddress3, 24 ) ) )
PrintSend ( ll_Label, ls_esc + "V215" + ls_esc + "H220" + ls_esc + "L0101" + ls_esc + "M" + "MADE IN USA" )

// Destination Info
PrintSend ( ll_Label, ls_esc + "V50" + ls_esc + "H595" + ls_esc + "L0101" + ls_esc + "M" + "TO" )
PrintSend ( ll_Label, ls_esc + "V75" + ls_esc + "H595" + ls_esc + "L0101" + ls_esc + "M" + upper ( left ( is_dname, 30 ) ) )
PrintSend ( ll_Label, ls_esc + "V100" + ls_esc + "H595" + ls_esc + "L0101" + ls_esc + "M" + upper ( left ( is_daddress1, 30 ) ) )
PrintSend ( ll_Label, ls_esc + "V125" + ls_esc + "H595" + ls_esc + "L0101" + ls_esc + "M" + upper ( left ( is_daddress2, 30 ) ) )
PrintSend ( ll_Label, ls_esc + "V150" + ls_esc + "H595" + ls_esc + "L0101" + ls_esc + "M" + upper ( left ( is_daddress3, 30 ) ) )

// Loc 1 (Zone)
if not lb_mixedload then
	PrintSend ( ll_Label, ls_esc + "V185" + ls_esc + "H595" + ls_esc + "L0101" + ls_esc + "M" + "STR" )
	PrintSend ( ll_Label, ls_esc + "V205" + ls_esc + "H595" + ls_esc + "L0101" + ls_esc + "M" + "LOC 1" )
	PrintSend ( ll_Label, ls_esc + "V160" + ls_esc + "H685" + ls_esc + "$B,60,88,0" + ls_esc + "$=" + is_zone )
end if

// 2D Bar Code
PrintSend ( ll_Label, ls_esc + "V50" + ls_esc + "H1070" + ls_esc + "BK020650031" + string( ll_char_encoded, "0000" ) + ls_2d_data )

//	Quantity Info
if not lb_mixedload then
	PrintSend ( ll_Label, ls_esc + "V243" + ls_esc + "H220" + ls_esc + "L0101" + ls_esc + "M" + "QTY" )
	PrintSend ( ll_Label, ls_esc + "V261" + ls_esc + "H220" + ls_esc + "L0101" + ls_esc + "M" + "(Q)" )
	PrintSend ( ll_Label, ls_esc + "V242" + ls_esc + "H260" + ls_esc + "L0303" + ls_esc + "S" + String(id_quantity, "######0") )
	PrintSend ( ll_Label, ls_esc + "V280" + ls_esc + "H260" + ls_esc + "BG03055" + ">H" + "Q" + ">C" + String(id_quantity,"000000") )
	if is_unit <> "PC" and is_unit <> "EA" and is_unit <> "UN" then
		PrintSend ( ll_Label, ls_esc + "V242" + ls_esc + "H505" + ls_esc + "L0202" + ls_esc + "M" + is_unit )
	end if
end if

//	Loc 2 (Linefeed)
if not lb_mixedload then
	PrintSend ( ll_Label, ls_esc + "V250" + ls_esc + "H595" + ls_esc + "L0101" + ls_esc + "M" + "LINE FEED LOC 2" )
	PrintSend ( ll_Label, ls_esc + "V260" + ls_esc + "H595" + ls_esc + "$B,60,88,0" + ls_esc + "$=" + is_linefeed )
end if

//	Destination Code
PrintSend ( ll_Label, ls_esc + "V250" + ls_esc + "H1040" + ls_esc + "L0101" + ls_esc + "M" + "CUST" )
PrintSend ( ll_Label, ls_esc + "V260" + ls_esc + "H1040" + ls_esc + "$B,60,88,0" + ls_esc + "$=" + left ( is_destination, 5 ) )

// Part
if not lb_mixedload then
	PrintSend ( ll_Label, ls_esc + "V345" + ls_esc + "H220" + ls_esc + "L0101" + ls_esc + "M" + "PART NO (P)" )
	PrintSend ( ll_Label, ls_esc + "V345" + ls_esc + "H260" + ls_esc + "$B,76,128,0" + ls_esc + "$=" + ls_show_custpart )
	PrintSend ( ll_Label, ls_esc + "V450" + ls_esc + "H260" + ls_esc + "BG03075" + ">H" + "P" + is_customerpart )
end if
...
// Supplier Code
PrintSend ( ll_Label, ls_esc + "V535" + ls_esc + "H220" + ls_esc + "L0101" + ls_esc + "M" + "SUPP (V)" )
PrintSend ( ll_Label, ls_esc + "V555" + ls_esc + "H260" + ls_esc + "BG03055" + ">H" + "V" + is_suppliercode )
PrintSend ( ll_Label, ls_esc + "V535" + ls_esc + "H620" + ls_esc + "$B,60,88,0" + ls_esc + "$=" + is_suppliercode )

// Container and Gross Weight
if not lb_mixedload then
	PrintSend ( ll_Label, ls_esc + "V570" + ls_esc + "H820" + ls_esc + "L0101" + ls_esc + "M" + "CONTAINER" )
	PrintSend ( ll_Label, ls_esc + "V590" + ls_esc + "H820" + ls_esc + "L0202" + ls_esc + "S" + ls_container )
end if
PrintSend ( ll_Label, ls_esc + "V535" + ls_esc + "H1165" + ls_esc + "L0101" + ls_esc + "M" + "GROSS WGT" )
PrintSend ( ll_Label, ls_esc + "V555" + ls_esc + "H1215" + ls_esc + "L0202" + ls_esc + "S" + string( ld_weight, "#####0" ) )
PrintSend ( ll_Label, ls_esc + "V565" + ls_esc + "H1365" + ls_esc + "L0101" + ls_esc + "M" + "LB" )
...
PrintSend ( ll_Label, ls_esc + "V630" + ls_esc + "H940" + ls_esc + "L0101" + ls_esc + "M" + "DATE" )
PrintSend ( ll_Label, ls_esc + "V650" + ls_esc + "H925" + ls_esc + "L0101" + ls_esc + "M" + upper ( string ( idt_objdate, "ddmmmyyyy" ) ) )

if is_type = 'S' then
	if lb_mixedload then
		PrintSend ( ll_Label, ls_esc + "V775" + ls_esc + "H700" + ls_esc + "L0202" + ls_esc + "M" + "MIXED LABEL" )
	else
		PrintSend ( ll_Label, ls_esc + "V775" + ls_esc + "H700" + ls_esc + "L0202" + ls_esc + "M" + "MASTER LABEL" )
	end if
end if
...
// Dock Code
PrintSend ( ll_Label, ls_esc + "V630" + ls_esc + "H1080" + ls_esc + "L0101" + ls_esc + "M" + "DOCK CODE" )
if is_type = 'S' then
	PrintSend ( ll_Label, ls_esc + "V620" + ls_esc + "H1105" + ls_esc + "$B,158,185,0" + ls_esc + "$=" + left ( is_dockcode, 3 ) )
	if lb_mixedload then
		PrintSend ( ll_Label, ls_esc + "V780" + ls_esc + "H1095" + ls_esc + "L0202" + ls_esc + "S" + "MIXED LABEL" )
	else
		PrintSend ( ll_Label, ls_esc + "V780" + ls_esc + "H1095" + ls_esc + "L0202" + ls_esc + "S" + "MASTER LABEL" )
	end if
else
	PrintSend ( ll_Label, ls_esc + "V615" + ls_esc + "H1105" + ls_esc + "$B,158,210,0" + ls_esc + "$=" + left ( is_dockcode, 3 ) )
end if

//  Draw Lines
PrintSend ( ll_label, ls_Esc + "V240" + ls_Esc + "H220" + ls_Esc + "FW02H810" )
...
PrintSend ( ll_label, ls_Esc + "V050" + ls_Esc + "H585" + ls_Esc + "FW02V190" )
PrintSend ( ll_label, ls_Esc + "V240" + ls_Esc + "H585" + ls_Esc + "FW02V095" )
PrintSend ( ll_label, ls_Esc + "V240" + ls_Esc + "H1030" + ls_Esc + "FW02V095" )
PrintSend ( ll_label, ls_Esc + "V525" + ls_Esc + "H810" + ls_Esc + "FW02V095" )
PrintSend ( ll_label, ls_Esc + "V620" + ls_Esc + "H1070" + ls_Esc + "FW02V190" )
...
on w_std_ford_2d.create
call super::create
end on

on w_std_ford_2d.destroy
call super::destroy
end on
