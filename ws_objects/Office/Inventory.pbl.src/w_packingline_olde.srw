$PBExportHeader$w_packingline_olde.srw
forward
global type w_packingline_olde from w_sheet_4t
end type
type em_date from u_em within w_packingline_olde
end type
type st_message from statictext within w_packingline_olde
end type
type cb_message from commandbutton within w_packingline_olde
end type
type cbx_visual_pallet from checkbox within w_packingline_olde
end type
type st_6 from statictext within w_packingline_olde
end type
type st_timer from statictext within w_packingline_olde
end type
type st_check from statictext within w_packingline_olde
end type
type sle_percentage from singlelineedit within w_packingline_olde
end type
type st_1 from statictext within w_packingline_olde
end type
type st_part_info from statictext within w_packingline_olde
end type
type st_8 from statictext within w_packingline_olde
end type
type st_7 from statictext within w_packingline_olde
end type
type p_4 from picture within w_packingline_olde
end type
type cbx_1 from checkbox within w_packingline_olde
end type
type lb_um from listbox within w_packingline_olde
end type
type st_suffix from statictext within w_packingline_olde
end type
type cbx_stage from checkbox within w_packingline_olde
end type
type sle_operation from statictext within w_packingline_olde
end type
type st_done from statictext within w_packingline_olde
end type
type st_percentage_value from statictext within w_packingline_olde
end type
type st_percentage from statictext within w_packingline_olde
end type
type cb_show_cancel from commandbutton within w_packingline_olde
end type
type cb_show_save from commandbutton within w_packingline_olde
end type
type sle_show_pallet from singlelineedit within w_packingline_olde
end type
type st_show_pallet from statictext within w_packingline_olde
end type
type sle_show_object from singlelineedit within w_packingline_olde
end type
type st_show_object from statictext within w_packingline_olde
end type
type cb_show from commandbutton within w_packingline_olde
end type
type ddlb_units from dropdownlistbox within w_packingline_olde
end type
type dw_temp from datawindow within w_packingline_olde
end type
type ddlb_machine from dropdownlistbox within w_packingline_olde
end type
type p_drag from picture within w_packingline_olde
end type
type p_trash from picture within w_packingline_olde
end type
type st_pallet from statictext within w_packingline_olde
end type
type st_serial41 from statictext within w_packingline_olde
end type
type st_serial42 from statictext within w_packingline_olde
end type
type st_serial43 from statictext within w_packingline_olde
end type
type st_serial44 from statictext within w_packingline_olde
end type
type st_serial45 from statictext within w_packingline_olde
end type
type st_serial46 from statictext within w_packingline_olde
end type
type st_serial47 from statictext within w_packingline_olde
end type
type st_serial48 from statictext within w_packingline_olde
end type
type p_mode from picture within w_packingline_olde
end type
type st_4 from statictext within w_packingline_olde
end type
type dw_object_info from datawindow within w_packingline_olde
end type
type dw_requirement from u_dw within w_packingline_olde
end type
type sle_base from singlelineedit within w_packingline_olde
end type
type st_5 from statictext within w_packingline_olde
end type
type dw_part from datawindow within w_packingline_olde
end type
type uo_boxes_on_pallet from u_boxes_on_pallet within w_packingline_olde
end type
type dw_objects from datawindow within w_packingline_olde
end type
type p_1 from picture within w_packingline_olde
end type
type st_2 from statictext within w_packingline_olde
end type
type p_2 from picture within w_packingline_olde
end type
type st_3 from statictext within w_packingline_olde
end type
type st_10 from statictext within w_packingline_olde
end type
type gb_4 from groupbox within w_packingline_olde
end type
type gb_3 from groupbox within w_packingline_olde
end type
type gb_5 from groupbox within w_packingline_olde
end type
type gb_2 from groupbox within w_packingline_olde
end type
type gb_1 from groupbox within w_packingline_olde
end type
type uo_visual_pallet from u_pallet_contents within w_packingline_olde
end type
end forward
...
string menuname = "m_packline_olde"
...
global w_packingline_olde w_packingline_olde

type variables

constant int REFRESHINTERVAL = 180 // 3 minutes
...
String	is_ScaleUserInputTrigger
String	is_DragMode
...
public function boolean wf_check_for_scale ()
...
IF ib_ScaleNeeded THEN
	ib_CompleteAfterScale = TRUE
	PostEvent ( "ue_popup_scale" )
	Return
END IF
...
If f_get_string_value(dw_part.GetItemString(1, "part")) > " " then
	...
	For l_i_Count = 1 to l_i_TotalBoxes
		...
		m_packline_olde.m_operation.m_jobcompletion.Enabled	= FALSE		//cb_job_comp.Enabled	= FALSE
...
//		ll_Serial = Message.DoubleParm
		...
		Else
			l_i_Count					= l_i_TotalBoxes + 1
			m_packline_olde.m_operation.m_jobcompletion.Enabled		= TRUE
...
public function boolean wf_check_for_scale ();String	s_ScaleAttached, &
			s_Part, &
			s_PackageType, &
			s_PackageIsObject

s_Part			= Trim ( f_get_string_value ( dw_part.GetItemString ( 1, "part" ) ) )
s_PackageType	= Trim ( f_get_string_value ( dw_part.GetItemString ( 1, "packagetype" ) ) )

If s_Part = "" Or s_PackageType = "" Then Return FALSE

SELECT part_packaging.scale_interface
  INTO :s_ScaleAttached
  FROM part_packaging  
 WHERE ( part_packaging.part = :s_Part ) AND  
       ( part_packaging.code = :s_PackageType )   ;

If SQLCA.SQLCode = 0 Then
	If s_ScaleAttached = 'Y' Then 
		m_packline_olde.m_operation.m_scaleinterface.Enabled = TRUE
		ib_ScaleNeeded = TRUE
		Return TRUE
	Else
		m_packline_olde.m_operation.m_scaleinterface.Enabled = FALSE
		ib_ScaleNeeded = FALSE
		Return FALSE
	End if
Else
	m_packline_olde.m_operation.m_scaleinterface.Enabled = FALSE
...
m_packline_olde.m_operation.m_jobcompletion.Enabled		= FALSE
...
if b_ChangeDate then
	b_ChangeDate = FALSE
	Timer(1, This)
	st_percentage.Visible = False
	If true then //szReturnedString > " " then
		dw_requirement.event pfc_Retrieve()
		SetNull(iSuffix)
	...
	End If
Elseif ib_Timer then

	If iCount >= REFRESHINTERVAL Then
	...
	Else
		sle_percentage.width		= sle_base.width * iCount / REFRESHINTERVAL
		sle_percentage.Visible 	= True
		iCount ++

	End If	

	st_timer.Text = String ( REFRESHINTERVAL - iCount ) 

Else
	sle_percentage.Visible = FALSE
	st_timer.Text = String(REFRESHINTERVAL)
	iCount = 0
End If
end event
...
on w_packingline_olde.create
int iCurrent
call super::create
if IsValid(this.MenuID) then destroy(this.MenuID)
if this.MenuName = "m_packline_olde" then this.MenuID = create m_packline_olde
...
this.Control[iCurrent+3]=this.cb_message
this.Control[iCurrent+4]=this.cbx_visual_pallet
this.Control[iCurrent+5]=this.st_6
this.Control[iCurrent+6]=this.st_timer
this.Control[iCurrent+7]=this.st_check
this.Control[iCurrent+8]=this.sle_percentage
this.Control[iCurrent+9]=this.st_1
this.Control[iCurrent+10]=this.st_part_info
...
this.Control[iCurrent+15]=this.lb_um
this.Control[iCurrent+16]=this.st_suffix
this.Control[iCurrent+17]=this.cbx_stage
this.Control[iCurrent+18]=this.sle_operation
this.Control[iCurrent+19]=this.st_done
this.Control[iCurrent+20]=this.st_percentage_value
this.Control[iCurrent+21]=this.st_percentage
this.Control[iCurrent+22]=this.cb_show_cancel
this.Control[iCurrent+23]=this.cb_show_save
this.Control[iCurrent+24]=this.sle_show_pallet
this.Control[iCurrent+25]=this.st_show_pallet
this.Control[iCurrent+26]=this.sle_show_object
this.Control[iCurrent+27]=this.st_show_object
this.Control[iCurrent+28]=this.cb_show
this.Control[iCurrent+29]=this.ddlb_units
this.Control[iCurrent+30]=this.dw_temp
this.Control[iCurrent+31]=this.ddlb_machine
this.Control[iCurrent+32]=this.p_drag
this.Control[iCurrent+33]=this.p_trash
this.Control[iCurrent+34]=this.st_pallet
this.Control[iCurrent+35]=this.st_serial41
this.Control[iCurrent+36]=this.st_serial42
this.Control[iCurrent+37]=this.st_serial43
this.Control[iCurrent+38]=this.st_serial44
this.Control[iCurrent+39]=this.st_serial45
this.Control[iCurrent+40]=this.st_serial46
this.Control[iCurrent+41]=this.st_serial47
this.Control[iCurrent+42]=this.st_serial48
this.Control[iCurrent+43]=this.p_mode
this.Control[iCurrent+44]=this.st_4
this.Control[iCurrent+45]=this.dw_object_info
this.Control[iCurrent+46]=this.dw_requirement
this.Control[iCurrent+47]=this.sle_base
this.Control[iCurrent+48]=this.st_5
this.Control[iCurrent+49]=this.dw_part
this.Control[iCurrent+50]=this.uo_boxes_on_pallet
this.Control[iCurrent+51]=this.dw_objects
this.Control[iCurrent+52]=this.p_1
this.Control[iCurrent+53]=this.st_2
this.Control[iCurrent+54]=this.p_2
this.Control[iCurrent+55]=this.st_3
this.Control[iCurrent+56]=this.st_10
this.Control[iCurrent+57]=this.gb_4
this.Control[iCurrent+58]=this.gb_3
this.Control[iCurrent+59]=this.gb_5
this.Control[iCurrent+60]=this.gb_2
this.Control[iCurrent+61]=this.gb_1
this.Control[iCurrent+62]=this.uo_visual_pallet
end on

on w_packingline_olde.destroy
call super::destroy
...
event selectionchanged;dw_requirement.event pfc_retrieve()
end event
...
event retrieveend;
//	Do this filtering and sorting business before restoring the active row...
if	cbx_1.Checked then
	choose case szQueue
		case "D"
			dw_requirement.SetFilter("shipper_detail_qty_required >  shipper_detail_pack_line_qty")
...
//	Now go restore the active row.
super::event retrieveend(rowcount)
...
Datetime ldt_retrdate
szQueue	= wf_get_schedule_queue(ddlb_machine.text)
...
If szQueue = "I" Then
	ib_Timer = FALSE
	if	dw_requirement.DataObject <> "dw_blank_dw_gray" then
...
ElseIf szQueue = "H" then
	ib_Timer = TRUE
	if	dw_requirement.DataObject <> "dw_hard_queue_information" then
		dw_requirement.Reset()
	...
	dw_requirement.of_Refresh(true)
...
Elseif szQueue = "O" Then
	ib_Timer = TRUE
	if	dw_requirement.DataObject <> "d_packline_order_detail_information" then
		dw_requirement.Reset()
...
Elseif szQueue = "F" Then
	ib_Timer = TRUE
	if	dw_requirement.DataObject <> "d_packline_order_detail_router_info" then
		dw_requirement.Reset()
...
Else
	ib_Timer = TRUE
	szQueue	= 'D'
	if	dw_requirement.DataObject <> "dw_shipper_detail_destination_info" then
		dw_requirement.Reset()
...
dw_requirement.SetRedraw(true)
return dw_requirement.RowCount()
end event

event activerowchanged;call super::activerowchanged;
If	activeRow > 0 and RowCount() >= activeRow then
	iDemandRow = activeRow
	iPalletSerial = 0
	ib_Timer = TRUE
	If szQueue = "D" then
...
//		ls_WorkOrder 	= String ( iShipper )
	...
	Elseif szQueue = "O" Then
		...
		If iSuffix > 0 Then
			...
			INTO		:nQtyCompleted
			FROM		object 
			WHERE 	origin = convert(varchar, :ll_Order) and
						part = :szPart and 
						suffix = :iSuffix ;
		Else
			SELECT 	Sum(std_quantity) 
		...
		st_part_info.text	= "Packing for Order: " + string(ll_Order)
...
on itemfocuschanged;wf_check_for_scale ( )
