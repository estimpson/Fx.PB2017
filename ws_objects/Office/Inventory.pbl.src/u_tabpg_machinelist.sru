$PBExportHeader$u_tabpg_machinelist.sru
forward
global type u_tabpg_machinelist from u_tabpg_dw
end type
type cb_newplanning from commandbutton within u_tabpg_machinelist
end type
end forward
...
global u_tabpg_machinelist u_tabpg_machinelist
...
on u_tabpg_machinelist.destroy
call super::destroy
...
type gb_1 from u_tabpg_dw`gb_1 within u_tabpg_machinelist
end type

type dw_1 from u_tabpg_dw`dw_1 within u_tabpg_machinelist
string dataobject = "d_dbo_mes_machinelist"
end type
