...
forward
global type w_customerservice from w_sheet_4t
end type
type dw_parm from datawindow within w_customerservice
end type
type uo_1 from u_explorer_plus within w_customerservice
end type
type str_wheres from structure within w_customerservice
end type
end forward
