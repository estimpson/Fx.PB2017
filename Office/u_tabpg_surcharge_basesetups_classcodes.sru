HA$PBExportHeader$u_tabpg_surcharge_basesetups_classcodes.sru
forward
global type u_tabpg_surcharge_basesetups_classcodes from u_tabpg_dw
end type
type cb_1 from commandbutton within u_tabpg_surcharge_basesetups_classcodes
end type
type cb_2 from commandbutton within u_tabpg_surcharge_basesetups_classcodes
end type
type dw_quickgridmenu from u_fxdw_quickgridmenu within u_tabpg_surcharge_basesetups_classcodes
end type
end forward
...
global u_tabpg_surcharge_basesetups_classcodes u_tabpg_surcharge_basesetups_classcodes
...
on u_tabpg_surcharge_basesetups_classcodes.create
int iCurrent
call super::create
...
on u_tabpg_surcharge_basesetups_classcodes.destroy
call super::destroy
destroy(this.cb_1)
destroy(this.cb_2)
...
type gb_1 from u_tabpg_dw`gb_1 within u_tabpg_surcharge_basesetups_classcodes
string text = "Surcharge Classification Codes"
end type

type dw_1 from u_tabpg_dw`dw_1 within u_tabpg_surcharge_basesetups_classcodes
string dataobject = "d_surcharge_classcodes"
end type
