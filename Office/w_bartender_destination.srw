HA$PBExportHeader$w_bartender_destination.srw
forward
global type w_bartender_destination from window
end type
end forward
...
global w_bartender_destination w_bartender_destination
...
on w_bartender_destination.create
end on

on w_bartender_destination.destroy
end on
