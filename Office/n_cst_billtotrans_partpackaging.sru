HA$PBExportHeader$n_cst_billtotrans_partpackaging.sru
forward
global type n_cst_billtotrans_partpackaging from n_cst_fxtrans
end type
end forward

global type n_cst_billtotrans_partpackaging from n_cst_fxtrans
end type
global n_cst_billtotrans_partpackaging n_cst_billtotrans_partpackaging
...
forward prototypes
public function integer enablepack (string billtocode, string partcode, string packagingcode)
public function integer disablepack (string billtocode, string partcode, string packagingcode)
public function integer setdefaultpack (string billtocode, string partcode, string packagingcode)
public function integer enablepackwithwarning (string billtocode, string partcode, string packagingcode)
public function integer verifypack (string billtocode, string partcode, string packagingcode, ref string defaultpackagingcode, ref integer packdisabled, ref integer packenabled, ref integer packwarn)
end prototypes
...
declare EnablePack procedure for dbo.usp_BillTo_PartPackaging_EnablePack
...
//	Attempt to add object to cycle count.
declare DisablePack procedure for dbo.usp_BillTo_PartPackaging_DisablePack
	@BillToCode = :billToCode
,	@PartCode = :partCode
,	@PackagingCode = :packagingCode
,	@TranDT = :tranDT output
...
//	Attempt to add object to cycle count.
declare SetDefaultPack procedure for dbo.usp_BillTo_PartPackaging_SetDefaultPack
	@BillToCode = :billToCode
,	@PartCode = :partCode
,	@PackagingCode = :packagingCode
,	@TranDT = :tranDT output
...
//	Attempt to add object to cycle count.
declare EnablePackWithWarning procedure for dbo.usp_BillTo_PartPackaging_EnablePackWithWarning
	@BillToCode = :billToCode
,	@PartCode = :partCode
,	@PackagingCode = :packagingCode
,	@TranDT = :tranDT output
...
//	Attempt to add object to cycle count.
declare VerifyPack procedure for dbo.usp_BillTo_PartPackaging_VerifyPack
	@BillToCode = :billToCode
,	@PartCode = :partCode
,	@PackagingCode = :packagingCode
...
on n_cst_billtotrans_partpackaging.create
call super::create
end on

on n_cst_billtotrans_partpackaging.destroy
call super::destroy
end on
