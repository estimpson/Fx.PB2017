HA$PBExportHeader$w_aztec_raw.srw
forward
global type w_aztec_raw from Window
end type
end forward
...
global w_aztec_raw w_aztec_raw
...
PrintSend ( ll_Label, cEsc + "V270" + cEsc + "H870" + cEsc + "$A,125,100,0" + cEsc + "$=" + "R A W" )
...
on w_aztec_raw.create
end on

on w_aztec_raw.destroy
end on
