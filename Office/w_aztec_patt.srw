HA$PBExportHeader$w_aztec_patt.srw
forward
global type w_aztec_patt from Window
end type
end forward
...
global w_aztec_patt w_aztec_patt
...
PrintSend ( ll_Label, cEsc + "V270" + cEsc + "H870" + cEsc + "$A,125,100,0" + cEsc + "$=" + "PATT" )
...
on w_aztec_patt.create
end on

on w_aztec_patt.destroy
end on
