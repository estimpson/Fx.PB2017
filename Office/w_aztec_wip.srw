HA$PBExportHeader$w_aztec_wip.srw
forward
global type w_aztec_wip from window
end type
end forward
...
global w_aztec_wip w_aztec_wip
...
PrintSend ( ll_Label, cEsc + "V270" + cEsc + "H870" + cEsc + "$A,125,100,0" + cEsc + "$=" + "W I P" )
...
on w_aztec_wip.create
end on

on w_aztec_wip.destroy
end on
