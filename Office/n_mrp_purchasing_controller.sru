HA$PBExportHeader$n_mrp_purchasing_controller.sru
forward
...
_headerDetailView.uo_2.ShowControl(_purchasePartView)
...
_parentSheet.OpenUserObject(_purchasePartView, "u_tab_4t")
_purchasePartView.OpenTab(_leftRightPOReleasesView, "u_panel_leftright2", 0)
_leftRightPOReleasesView.Text = "Release Schedule"
_purchasePartView.SelectTab(1)
_purchasePartView.OpenTab(_netoutPartAuditView, "u_tabpg_mrp_netoutpartaudit", 0)
_headerDetailView.uo_2.AddPanelControl(_purchasePartView)
...
string blanketPart
if	_trans.GetPOBlanketPart(_poNumber, blanketPart) = SUCCESS then
	_netoutPartAuditView.SetPart(blanketPart)
end if
