HA$PBExportHeader$w_aztec_ppap.srw
forward
global type w_aztec_ppap from Window
end type
end forward
...
global w_aztec_ppap w_aztec_ppap
...
PrintSend ( ll_Label, cEsc + "V270" + cEsc + "H870" + cEsc + "$A,125,100,0" + cEsc + "$=" + "PPAP" )
...
on w_aztec_ppap.create
end on

on w_aztec_ppap.destroy
end on
