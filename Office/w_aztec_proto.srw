HA$PBExportHeader$w_aztec_proto.srw
forward
global type w_aztec_proto from Window
end type
end forward
...
global w_aztec_proto w_aztec_proto
...
PrintSend ( ll_Label, cEsc + "V070" + cEsc + "H150" + cEsc + "$A,200,100,0" + cEsc + "$=" + szPart )
...
PrintSend ( ll_Label, cEsc + "V440" + cEsc + "H755" + cEsc + "WL1" + szUnit )

PrintSend ( ll_Label, cEsc + "V520" + cEsc + "H146" + cEsc + "M" + "SERIAL #" )
PrintSend ( ll_Label, cEsc + "V530" + cEsc + "H150" + cEsc + "$A,110,100,0" + cEsc + "$=" + String(lserial) )
PrintSend ( ll_Label, cEsc + "V688" + cEsc + "H146" + cEsc + "B102095" + "*" + "S" + String ( lSerial ) + "*" )
PrintSend ( ll_Label, cEsc + "V270" + cEsc + "H870" + cEsc + "$A,125,100,0" + cEsc + "$=" + "PROTO." )
...
on w_aztec_proto.create
end on

on w_aztec_proto.destroy
end on
